    ...
    <>
      ...
      <h3>Social Network</h3>
              <div>
                <div>
                <>
                  <a className={styles.imag} href={head.url_facebook}><Image src={`${directus.url}assets/${icon.item_Facebook}?width=40`} alt="logo" width={40} height={40} /></a>
                </>
                <>
                  <a className={styles.imag} href={head.url_linkedin}><Image src={`${directus.url}assets/${icon.item_linkedin}?width=40`} alt="logo" width={40} height={40} /></a>
                </>
                <>
                  <a className={styles.imag} href={head.url_X}><Image src={`${directus.url}assets/${icon.item_twiter}?width=40`} alt="logo" width={40} height={40} /></a>
                </>
                  </div>
                  <div>
                    <h5>Descargar PDF</h5>
